<!-- Modal start -->
<div id="modal2" class="modal-bgrnd hidden">
  <div class="modal">
    <div class="modal-main" >
      <header class="modal-header">
        <h2 class="text-sm">New art pieces for fall season</h2>
        <div class="focus:outline-none p-2">
          <svg onclick="closeModal('modal2')" class="fill-current svg-a" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18">
            <path
