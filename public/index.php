  ...
  <div class="box">
    ...
    <div class="container">
      ...
      <div class="text-center mt-60">
        ...
        <h1 id="header" class="header text-center my-4">Discover, learn, and see extraordinary art.</h1>
        <div class="text-center" style="margin-top: 60px;">
          <a href="collection.php" class="custom-button mr-20 text-xs">On view now</a>
          <a href="about.php" class="custom-button-sec ml-20 text-xs">Contact us</a>
        </div>
      </div>
          ...
          <div class="w-full">
            ...
            <div class="block mt-2">
              <div class="flex align-center">
                <img class="creator" src="../static/assets/artist/johannes-vermeer/artist.jpg"  alt="artist" width="96" height="96">
                <div class="mx-2">
                  <p>Creator</p>
      ...
      <div class="mt-60 my-4">
        ...
        <div class="grid-more-info mt-4">

          <div class="mx-2">
            <div>
              <svg id="bounce0" class="mb-2" xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" viewBox="0 0 16 16">
          ...
          <div class="mx-2">
            <div>
              <svg id="bounce1" class="mb-2" xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" viewBox="0 0 16 16">
          ...
          <div class="mx-2">
            <div>
              <svg id="bounce2" class="mb-2" xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" viewBox="0 0 16 16">
      ...
      <div class="slider relative">
        ...
        <div class="dots-nav absolute">
          <div class="dots flex">
            <div id="dot-a">
              <svg class="hidden" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="white" viewBox="0 0 16 16">
      ...
      <div>
        ...
        <div>
          <div class="my-4">
            <p>New rare and intresting art pieces for fall season don't miss it—<span onclick="openModal('modal0')" class="link">Read more</span></p>
          </div>
          <div class="my-4">
            <p>From july 24 to 26 we gonna be closed sorry for inconveniens—<span onclick="openModal('modal1')" class="link">Read more</span></p>
          </div>
          <div class="my-4">
            <p>Github and other stuff for website—<span onclick="openModal('modal2')" class="link">Read more</span></p>
          </div>

          <div class="my-4">
            <p><span onclick="openModal('modal3')" class="link">All posts</span></p>
          </div>
        </div>
      </div>
